...
Процедура Страницы_Инициализация()
	...
	Структура.Вставить("ПриходныйКассовыйОрдер", "ПКО");
	Структура.Вставить("РасходныйКассовыйОрдер", "РКО");
	Структура.Вставить("ДенежныйЧек", "Денежные чеки");
	Структура.Вставить("ОплатаОтПокупателяПлатежнойКартой", "Оплата от покупателя платежной картой");
	Структура.Вставить("ОбъявлениеНаВзносНаличными", "Объявления на взнос наличными");
	Структура.Вставить("ВнутреннееПеремещениеНаличныхДенежныхСредств", "Внутренние перемещения наличных денежных средств");
