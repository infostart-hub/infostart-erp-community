...
Процедура ВыполнитьДействие(Команда)
	Если Команда.Имя="ПоказатьДеревоСпецификации" Тогда
		...
		Если НЕ ТипЗнч(Ссылка)=Тип("ДокументСсылка.Спецификация") Тогда Возврат; КонецЕсли;
		ОткрытьФорму("Документ.Спецификация.Форма.ФормаДеревоСпецификации", Новый Структура("Спецификация", Ссылка), ЭтаФорма, УникальныйИдентификатор,,,,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
	Иначе
