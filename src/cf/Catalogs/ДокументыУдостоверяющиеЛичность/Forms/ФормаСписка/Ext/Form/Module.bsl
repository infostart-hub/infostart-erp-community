...
Процедура ВыполнитьДействие(Команда)
	...
	Если Команда.Имя="ЗаполинтьПоУмолчанию" Тогда
		ЗаполинтьПоУмолчанию();
		Элементы.ДинамическийСписок.Обновить();
	КонецЕсли;	
КонецПроцедуры

&НаСервереБезКонтекста
Процедура ЗаполинтьПоУмолчанию()
	Справочники.ДокументыУдостоверяющиеЛичность.ЗаполнитьПоУмолчанию();
КонецПроцедуры
