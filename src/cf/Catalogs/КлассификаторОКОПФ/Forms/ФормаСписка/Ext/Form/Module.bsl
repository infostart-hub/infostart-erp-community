...
Процедура ПодборИзКлассификатора()
	ОткрытьФорму("Справочник.КлассификаторОКОПФ.Форма.ФормаПодбораИзКлассификатора",,ЭтаФорма, УникальныйИдентификатор,,,,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
КонецПроцедуры
